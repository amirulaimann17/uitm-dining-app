...
class StudentOrderHistoryPage extends StatefulWidget {
  final int studentId;
  ...
  @override
  _StudentOrderHistoryPageState createState() =>
      _StudentOrderHistoryPageState();
}

class _StudentOrderHistoryPageState extends State<StudentOrderHistoryPage> {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: FutureBuilder<List<Order>>(
          future: db.getCompletedOrdersByStudentId(widget.studentId),
